...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'station_de_nettoyage_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/maxime/projets-ros/integration_ws/install/${idir}'.  Ask the maintainer 'maximo <maximo@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/maxime/projets-ros/integration_ws/install/lib;/home/maxime/projets-ros/packages_ext_ws/devel/lib;/opt/ros/indigo/lib)
