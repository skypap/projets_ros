...
if("TRUE" STREQUAL "TRUE")
  set(ur_driver_SOURCE_PREFIX /home/maxime/projets-ros/packages_ext_ws/src/universal_robot/ur_driver)
  set(ur_driver_DEVEL_PREFIX /home/maxime/projets-ros/packages_ext_ws/devel)
  ...
  set(ur_driver_INSTALL_PREFIX /home/maxime/projets-ros/packages_ext_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Felix Messmer <fxm@ipa.fhg.de>, G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/maxime/projets-ros/packages_ext_ws/src/universal_robot/ur_driver/${idir}'.  Ask the maintainer 'Felix Messmer <fxm@ipa.fhg.de>, G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ur_driver_dep}_FOUND)
      find_package(${ur_driver_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ur_driver_dep} REQUIRED ${depend_list})
  endif()
