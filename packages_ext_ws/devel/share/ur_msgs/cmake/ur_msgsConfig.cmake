...
if("TRUE" STREQUAL "TRUE")
  set(ur_msgs_SOURCE_PREFIX /home/maxime/projets-ros/packages_ext_ws/src/universal_robot/ur_msgs)
  set(ur_msgs_DEVEL_PREFIX /home/maxime/projets-ros/packages_ext_ws/devel)
  set(ur_msgs_INSTALL_PREFIX "")
  set(ur_msgs_PREFIX ${ur_msgs_DEVEL_PREFIX})
else()
  set(ur_msgs_SOURCE_PREFIX "")
  set(ur_msgs_DEVEL_PREFIX "")
  set(ur_msgs_INSTALL_PREFIX /home/maxime/projets-ros/packages_ext_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Felix Messmer <fxm@ipa.fhg.de>, G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/maxime/projets-ros/packages_ext_ws/src/universal_robot/ur_msgs/${idir}'.  Ask the maintainer 'Felix Messmer <fxm@ipa.fhg.de>, G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>' to fix it.")
    endif()
...
set(ur_msgs_EXPORTED_TARGETS "ur_msgs_generate_messages_cpp;ur_msgs_generate_messages_lisp;ur_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ur_msgs_dep}_FOUND)
      find_package(${ur_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ur_msgs_dep} REQUIRED ${depend_list})
  endif()
